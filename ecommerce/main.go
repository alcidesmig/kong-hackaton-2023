...
// Product struct represents a product with an ID and description.
type Product struct {
	ID          int    `json:"id"`
...
func main() {
	http.HandleFunc("/product", getProductDescription)
